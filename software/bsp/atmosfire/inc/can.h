/* Edited by Martin Trojer (mtrojer@arrownordic.com) */
...
*******************************************************************************/
static inline void CAN_EnterInitMode(u8 mask)
{
...
*******************************************************************************/
static inline void CAN_EnterTestMode(u8 mask)
{
	CAN->CR |= CAN_CR_TEST;
	CAN->TESTR |= mask;
}
...
*******************************************************************************/
static inline void CAN_ReleaseTxMessage(u32 msgobj)
{
...
*******************************************************************************/
static inline void CAN_ReleaseRxMessage(u32 msgobj)
{
...
*******************************************************************************/
static inline u32 CAN_IsMessageWaiting(u32 msgobj)
{
...
*                  to transmit, else 0
*******************************************************************************/
static inline u32 CAN_IsTransmitRequested(u32 msgobj)
{
...
*                  pending, else 0
*******************************************************************************/
static inline u32 CAN_IsInterruptPending(u32 msgobj)
{
...
*                  else 0
*******************************************************************************/
static inline u32 CAN_IsObjectValid(u32 msgobj)
{
